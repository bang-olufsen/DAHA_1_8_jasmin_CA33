...
/*!
* @file      adi_pwr_SC594_family_800MHz_config.h
*
* @brief     Header file for Power Service Configuration for 800MHz CCLK operation.
*
* @details
*
*/
...
#ifndef ADI_PWR_SC594_FAMILY_800MHZ_CONFIG_H
#define ADI_PWR_SC594_FAMILY_800MHZ_CONFIG_H
...
--------------------------
SHARC0 & its Accelerators  (CLKO0) : CCLK0_0      :  800 MHz
SHARC1 & its Accelerators  (CLKO1) : CCLK0_0      :  800 MHz
ARM                        (CLKO2) : CCLK1_0      :  800 MHz
DDR                        (CLKO3) : DCLK_0       :  800 MHz
CANFD                      (CLKO4) : OCLK_1       :  100 MHz
SPDIF                      (CLKO5) : SCLK1_EXEN_0 :  320 MHz
SPI                        (CLKO6) : SCLK0_0      :  100 MHz
GigE                       (CLKO7) : SCLK0_1      :  125 MHz
LP                         (CLKO8) : CCLK0_1      :  125 MHz
LP_DDR                     (CLKO9) : SYSCLK_1     :  250 MHz
OSPI_REFCLK                (CLKO10): SYSCLK_0     :  400 MHz
...
#define CFG0_BIT_CDU0_CFG3_SEL_VALUE                       (ENUM_CDU_CFG_IN0)        /*!< Macro for CDU CFG0 Selection */
...
#define CFG0_BIT_CGU0_CTL_MSEL                             64       /*!< Macro for CGU0 MSEL field */
/*****************************************CGU0_DIV**********************************************/
...
#endif /* define ADI_PWR_SC594_FAMILY_800MHZ_CONFIG_H */
