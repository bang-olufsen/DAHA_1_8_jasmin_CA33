...
src/System/Framework/SPI_ISR.doj: ../src/System/Framework/SPI_ISR.asm
	...
	easm21k -file-attr ProjectName="21593SDK05_Core1" -proc ADSP-21593 -si-revision any -g -DCORE1 -D_DEBUG @includes-bfe8aea91d4179dd62ea79f4fc503020.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "src/System/Framework/SPI_ISR.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
src/System/Framework/Word_Addressing_Core1.doj: ../src/System/Framework/Word_Addressing_Core1.c
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC C/C++ Compiler'
	cc21k -c -file-attr ProjectName="21593SDK05_Core1" -proc ADSP-21593 -flags-compiler --no_wrap_diagnostics -si-revision any -O -Ov100 -g -DCORE1 -D_DEBUG -DADI_DEBUG @includes-20c5ddc32ea027188962c6c2deb03d18.txt -structs-do-not-overlap -no-const-strings -no-multiline -warn-protos -double-size-32 -char-size-32 -swc -gnu-style-dependencies -MD -Mo "src/System/Framework/Word_Addressing_Core1.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
